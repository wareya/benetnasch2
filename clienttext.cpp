...
int main()
{
    ...
    std::cout << "CLENT: Awaiting response...\n";
    ...
    std::cout << "CLENT: Size: " << numbytes << " IP: " << out_ip << " Port: " << port << "\n";
    std::cout << "CLENT: Message: " << read_string(myself_sock, numbytes) << "\n";
